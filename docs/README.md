...
| Frontend técnico | [frontend-arquitetura.md](./frontend-arquitetura.md) | [frontend-mapa-telas-jornadas.md](./frontend-mapa-telas-jornadas.md), [frontend-componentes-primitives.md](./frontend-componentes-primitives.md), [frontend-formularios-estado-api.md](./frontend-formularios-estado-api.md), [frontend-analytics-observabilidade.md](./frontend-analytics-observabilidade.md), [frontend-seguranca.md](./frontend-seguranca.md), [frontend-entrega-runtime.md](./frontend-entrega-runtime.md), [frontend-pendencias-priorizadas.md](./frontend-pendencias-priorizadas.md), [frontend-qa-prontidao.md](./frontend-qa-prontidao.md), [qualidade-codigo.md](./qualidade-codigo.md), [performance-qa.md](./performance-qa.md) |
...
| Segurança e privacidade | [session-security.md](./session-security.md) | [frontend-seguranca.md](./frontend-seguranca.md), [dependency-security.md](./dependency-security.md), [encerramento-privacidade.md](./encerramento-privacidade.md) |
...
- [frontend-formularios-estado-api.md](./frontend-formularios-estado-api.md): padrões de formulários, estado local/navegável/sessão, API, erros, uploads, retry e idempotência.
- [frontend-analytics-observabilidade.md](./frontend-analytics-observabilidade.md): instrumentação first-party/legada, consentimento, Google/Meta, atribuição, deduplicação e fronteira entre telemetria e fatos do backend.
- [frontend-seguranca.md](./frontend-seguranca.md): fronteiras de confiança, sessão no navegador, autorização, storage, CORS/CSP, uploads, secrets e hardening do frontend.
- [frontend-entrega-runtime.md](./frontend-entrega-runtime.md): build Vite, lazy chunks, cache HTTP, stale asset recovery, SEO/noindex, sitemap, metadata e social preview.
- [frontend-pendencias-priorizadas.md](./frontend-pendencias-priorizadas.md): matriz consolidada dos findings abertos, prioridade, patch esperado e evidência necessária para fechamento.
- [frontend-qa-prontidao.md](./frontend-qa-prontidao.md): estratégia de testes, acessibilidade, mobile/WebKit, performance e critérios para considerar uma mudança de frontend pronta.
