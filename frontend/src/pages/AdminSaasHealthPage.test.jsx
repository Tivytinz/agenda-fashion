...
describe("ativação profissional no admin", () => {
  ...
  it("não oferece contato por WhatsApp sem autorização do profissional", async () => {
    ...
    expect(screen.getByText("WhatsApp não autorizado")).not.toBeNull();
    expect(screen.getByRole("link", { name: "E-mail" })).not.toBeNull();
  });
