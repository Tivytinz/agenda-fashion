...
>
> **Baseline avaliada:** estado após a Admin Wave 5 e preparação da Wave 6; os medidores ainda não foram executados com volume representativo.
>
...
representativo. A Wave 6 conserva um perfil agregado somente leitura; a
observação HTTP de 24–25/09/2026 não encontrou chamadas à auditoria e não
permite calcular p95.
...
preparou verificação da identidade do serviço QA e consulta de revisadas. A
Wave 6 prepara o volume QA; ainda falta execução representativa. Ver
`admin-wave-3-rf41-reconciliacao.md`, `admin-wave-4-rf41-qualificacao.md`,
`admin-wave-5-rf41-evidencia.md` e `admin-wave-6-rf41-qa-operacional.md`.
